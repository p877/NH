...
df2=pd.read_excel('start_end.xlsx',sheet_name='s1',engine='openpyxl')
df3=pd.read_excel('start_without_end.xlsx',sheet_name='s1',engine='openpyxl')
df2["target"]=1
df12=df2
...
features.to_csv("featureprocess.csv")
